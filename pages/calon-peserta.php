...
<body>
    <!-- tabel tampil -->
    <div class="container">
        <h5 class="text-left mt-5">DAFTAR CALON SISWA/PESERTA JWD DIGITAL TALENT</h5><br>
        <table class="table table-striped table-hover table-bordered">
            ...
            <tr class="text-center">
                ...
                <td>
                    <a data-bs-toggle="modal" data-bs-target="#edituser" style="text-decoration:none"
                        onclick="setEdit('<?php echo $data['id_siswa'] ?>', '<?php echo $data['nama_siswa'] ?>', '<?php echo $data['jenis_kelamin'] ?>', '<?php echo $data['alamat'] ?>', '<?php echo $data['agama'] ?>', '<?php echo $data['sekolah_asal'] ?>')">
                        <i class="btn btn-primary btn-sm mr-2">Edit</i>
                    </a>
                    <a href="pages/proses_delete.php?id_siswa=<?php echo $data['id_siswa']; ?>"
                        onclick="return confirm('Yakin ingin menghapus data ini?')">
                        <i class="btn btn-danger btn-sm mr-2">Delete</i>
                    </a>
                </td>
            </tr>
            <?php } ?>
                ...
                <div class="modal-body">
                    ...
                    <form class="row g-3" action="proses_edit.php" method="POST">
                        ...
                        <div class="mt-3 row">
                            ...
                            <div class="col-sm-10">
                                <textarea type="text" class="form-control" id="alamat-edit"
                                    name="alamat-edit"><?php echo $data['alamat'] ?></textarea>
                            </div>
                        </div>
                        <div class="mt-3 row">
                        ...
                        <div class="mt-3 row">
                            ...
                            <div class="col-sm-10">
                                <input value="<?php echo $data['sekolah_asal'] ?>" type="text" class="form-control"
                                    id="sekolah_asal-edit" name="sekolah_asal-edit">
                            </div>
                        </div>
                        ...
                        <div class="mt-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="submit" class="btn btn-primary" name="ubah" id="btn-simpan" value="Simpan">
                                <input type="text" class="form-control" id="id-edit" name="id_siswa-edit"
                                    style="display: none">
                            </div>
                        </div>
                    </form>
