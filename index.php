    ...
    <div class="container">
        <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
            <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-dark text-decoration-none">
                <span class="fs-4">DIGITAL TALENT - JWD-UNPAM</span>
            </a>
            <ul class="nav">
                <li class="nav-item"><a class="nav-link active" aria-current="page" aria-current="page"
                        href="index.php?p=calon-peserta" class="nav-link">Calon Peserta</a></li>
                <li class="nav-item"><a data-bs-toggle="modal" data-bs-target="#tambahuser" style="cursor:pointer"
                        class="nav-link">Daftar Baru</a></li>
            </ul>
        </header>
    </div>
                    ...
                    <div class="container">
                        <form class="row g-3" id="form" action="proses-tambah-peserta.php" method="POST">
                            ...
                            <div class="mt-3 row">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-primary position-relative" name="simpan"
